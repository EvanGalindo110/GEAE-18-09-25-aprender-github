...
### 4.	git config --global user.name "EvanGalindo110" 

### 5.	git config --global user.email "24308060610646@cetis61.edu.mx" o 	El --global significa que esta 
...
### 5.	git clone [https://github.com/EvanGalindo110/GEAE-18-09-25-aprender-github] 
...
### •	**.gitignore:** Un archivo especial donde listas archivos o carpetas que Git debe ignorar y no rastrear (ej. archivos de configuración locales, archivos temporales). Esto ayuda a mantener tu repositorio 
### limpio. 
